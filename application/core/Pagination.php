...
class Pagination
{
    ...
    public function get()
    {
        ...
        for ($page = $limits[0]; $page <= $limits[1]; $page++) {
            ...
            if ($page == $this->current_page) {
                $links .= '<li class="active"><a  href="#"><button style="text-align: center;" class="btn pagination">' . $page . '</a></button></li>';
            } else {
    ...
    private function generateHtml($page, $text = null)
    {
        ...
        return
                '<li><a href="' . $currentURI  . $page . '"><button class="btn pagination">' . $text . '</button></a></li>';
    }
    /**
